;;; ir-black-evolve-theme.el --- Port of ir-black theme and then customised by jmdb
...
;; load-theme' and select "ir-black-evolv".
...
(deftheme ir-black-evolv "Port of ir-black theme with Jims' Customisations")
...
(let ((*background-color*   "#000000")
  ...
  (custom-theme-set-faces
   ...
   `(rainbow-delimiters-depth-3-face ((t (:foreground "light blue"))))
...
(provide-theme 'ir-black-evolv)
;;; ir-black-evolv-theme.el ends here
