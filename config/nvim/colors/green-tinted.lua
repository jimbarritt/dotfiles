...
-- Kotlin-specific highlights (override LSP defaults)
hi('@keyword.kotlin', { fg = colors.keyword })
hi('@lsp.type.keyword.kotlin', { fg = colors.keyword })
hi('@lsp.keyword.kotlin', { fg = colors.keyword })
hi('@type.kotlin', { fg = colors.type })
hi('@function.kotlin', { fg = colors.fn_decl })
hi('@property.kotlin', { fg = colors.property })
hi('@variable.kotlin', { fg = colors.variable })
